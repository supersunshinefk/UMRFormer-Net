...
import torch
from UMRFormer_Net.training.loss_functions.TopK_loss import TopKLoss
from UMRFormer_Net.training.loss_functions.crossentropy import RobustCrossEntropyLoss
from UMRFormer_Net.utilities.nd_softmax import softmax_helper
from UMRFormer_Net.utilities.tensor_utilities import sum_tensor
...
def get_tp_fp_fn_tn(net_output, gt, axes=None, mask=None, square=False):
    ...
    :return:
    """
    # print("new_output>>>>>>>>>>>>", net_output.shape)
    # print("gt>>>>>>>>>>>>>>>>>>>",gt.shape)
    if axes is None:
    ...
    with torch.no_grad():
        ...
        # print("net_output.shape, gt.shape>>>>>>>>>>>>>", net_output.shape, gt.shape)
