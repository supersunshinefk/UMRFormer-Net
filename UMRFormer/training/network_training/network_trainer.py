...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        if 'UMRFormer_Net_use_progress_bar' in os.environ.keys():
            self.use_progress_bar = bool(int(os.environ['UMRFormer_Net_use_progress_bar']))
    ...
    def load_checkpoint_ram(self, checkpoint, train=True):
        ...
        # print("new_state_dict>>>>>>>>>>>>>>>>>>", new_state_dict,len(new_state_dict))
    ...
    def plot_network_architecture(self):
        """
        can be implemented (see UMRFormerTrainer) but does not have to. Not implemented here because it imposes stronger
