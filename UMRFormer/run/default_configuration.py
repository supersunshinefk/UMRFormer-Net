...
from UMRFormer_Net.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from batchgenerators.utilities.file_and_folder_operations import *
from UMRFormer_Net.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(UMRFormer_Net.__path__[0], "training", "network_training"),
                              base_module='UMRFormer_Net.training.network_training'):
    ...
    print("###############################################")
    print("I am running the following UMRFormer: %s" % network)
    ...
    print("###############################################")
    print(plans_file, output_folder_name, dataset_directory, batch_dice, stage, trainer_class)
