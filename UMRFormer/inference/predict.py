...
from UMRFormer_Net.inference.segmentation_export import save_segmentation_nifti_from_softmax, save_segmentation_nifti
...
from UMRFormer_Net.postprocessing.connected_components import load_remove_save, load_postprocessing
from UMRFormer_Net.training.model_restore import load_model_and_checkpoint_files
from UMRFormer_Net.training.network_training.UMRFormerTrainer import UMRFormerTrainer
from UMRFormer_Net.utilities.one_hot_encoding import to_one_hot
...
def preprocess_multithreaded(trainer, list_of_lists, output_files, num_processes=2, segs_from_prev_stage=None):
    ...
    assert isinstance(trainer, UMRFormerTrainer)
    q = Queue(1)
    processes = []
