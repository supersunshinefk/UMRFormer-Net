...
def test(fold):
    ...
    path='/disk7/fangkun/Synapse/UMRFormer_raw/UMRFormer_raw_data/UMRFormer_raw_data/Task007_Pancreas/'
    ...
    for label_path,infer_path in zip(label_list,infer_list):
        ...
        label_pancreas,label_cancer=process_label(label)
        infer_pancreas,infer_cancer=infersTs_process_label(infer)
