...
if __name__ == "__main__":
    ...
    plans = "UMRFormerPlansv2.1"

    overwrite_plans = {
        'UMRFormerTrainerCascadeFullRes': ['UMRFormerPlans'],
    }

    trainers = [
        'UMRFormerTrainerCascadeFullRes',
        'UMRFormerTrainerV2CascadeFullRes_EducatedGuess',
        'UMRFormerTrainerV2CascadeFullRes_EducatedGuess2',
        'UMRFormerTrainerV2CascadeFullRes_EducatedGuess3',
        'UMRFormerTrainerV2CascadeFullRes_lowerLR',
        'UMRFormerTrainerV2CascadeFullRes',
        'UMRFormerTrainerV2CascadeFullRes_noConnComp',
        'UMRFormerTrainerV2CascadeFullRes_shorter_lowerLR',
        'UMRFormerTrainerV2CascadeFullRes_shorter',
        'UMRFormerTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
