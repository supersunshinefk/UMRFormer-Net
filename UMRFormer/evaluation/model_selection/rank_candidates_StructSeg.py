...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'UMRFormerTrainerV2_2': ["UMRFormerPlans", "UMRFormerPlans_customClip"], # r
        'UMRFormerTrainerV2_2_noMirror': ["UMRFormerPlans", "UMRFormerPlans_customClip"],  # r
        'UMRFormerTrainerV2_lessMomentum_noMirror': ["UMRFormerPlans", "UMRFormerPlans_customClip"],  # r
        'UMRFormerTrainerV2_2_structSeg_noMirror': ["UMRFormerPlans", "UMRFormerPlans_customClip"],  # r
        'UMRFormerTrainerV2_2_structSeg': ["UMRFormerPlans", "UMRFormerPlans_customClip"],  # r
        'UMRFormerTrainerV2_lessMomentum_noMirror_structSeg': ["UMRFormerPlans", "UMRFormerPlans_customClip"],  # r
        'UMRFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["UMRFormerPlans", "UMRFormerPlans_customClip"],  # r
        'UMRFormerTrainerV2_FabiansResUNet_structSet_NoMirror': ["UMRFormerPlans", "UMRFormerPlans_customClip"],  # r
        'UMRFormerTrainerV2_FabiansResUNet_structSet': ["UMRFormerPlans", "UMRFormerPlans_customClip"],  # r

    }

    trainers = ['UMRFormerTrainer'] + [
        'UMRFormerTrainerV2_2',
        'UMRFormerTrainerV2_lessMomentum_noMirror',
        'UMRFormerTrainerV2_2_noMirror',
        'UMRFormerTrainerV2_2_structSeg_noMirror',
        'UMRFormerTrainerV2_2_structSeg',
        'UMRFormerTrainerV2_lessMomentum_noMirror_structSeg',
        'UMRFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'UMRFormerTrainerV2_FabiansResUNet_structSet_NoMirror',
        'UMRFormerTrainerV2_FabiansResUNet_structSet',
    ]
