...
from UMRFormer_Net.experiment_planning.experiment_planner_baseline_3DUNet_v21 import ExperimentPlanner3D_v21
...
class ExperimentPlanner3D_v21_Pretrained(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder, pretrained_model_plans_file: str,
        ...
        self.data_identifier = "UMRFormerData_pretrained_" + pretrained_name
        self.plans_fname = join(self.preprocessed_output_folder, "UMRFormerPlans_pretrained_%s_plans_3D.pkl" % pretrained_name)
