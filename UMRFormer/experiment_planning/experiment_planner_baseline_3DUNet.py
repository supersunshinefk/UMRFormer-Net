...
from UMRFormer_Net.configuration import default_num_threads
...
from UMRFormer_Net.experiment_planning.utils import create_lists_from_splitted_dataset
from UMRFormer_Net.network_architecture.generic_UNet import Generic_UNet
from UMRFormer_Net.paths import *
from UMRFormer_Net.preprocessing.cropping import get_case_identifier_from_npz
...
class ExperimentPlanner(object):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "UMRFormerPlans" + "fixed_plans_3D.pkl")
    ...
    def plan_experiment(self):
        ...
        # thanks Zakiyi (https://github.com/MIC-DKFZ/UMRFormer/issues/61) for spotting this bug :-)
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(UMRFormer_Net.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="UMRFormer_Net.preprocessing")
...
if __name__ == "__main__":
    ...
    for i in task_ids:
        i = int(i)
        candidates = subdirs(UMRFormer_cropped_data, prefix="Task%03.0d" % i, join=False)
