...
from UMRFormer_Net.experiment_planning.common_utils import get_pool_and_conv_props
from UMRFormer_Net.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner
from UMRFormer_Net.experiment_planning.utils import add_classes_in_slice_info
from UMRFormer_Net.network_architecture.generic_UNet import Generic_UNet
from UMRFormer_Net.paths import *
from UMRFormer_Net.preprocessing.preprocessing import PreprocessorFor2D
...
class ExperimentPlanner2D(ExperimentPlanner):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "UMRFormerPlans" + "_plans_2D.pkl")
