...
def get_commands(configurations, regular_trainer="UMRFormerTrainerV2", cascade_trainer="UMRFormerTrainerV2CascadeFullRes",
    ...
    for task in configurations:
        ...
        for m in models:
            ...
            folder = get_output_folder_name(m, task, trainer, plans, overwrite_training_output_dir="/datasets/datasets_fabian/results/UMRFormer")
